...
<html lang="en">
    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand" href="admin.php">Dallim Store Admin</a>
            ...
            <ul class="navbar-nav ml-auto ml-md-0">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                        <a class="dropdown-item" href="consup.php">Actualizar empleado</a>
                        <a class="dropdown-item" href="consulta.html">Adminitrador de personal</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item">
                            Salir
                            <a class="navbar-item" href="login/indexlogin.php">
                        </a>
                    </div>
                </li>
            </ul>
                                ...
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    ...
                                    <div class="collapse" id="pagesCollapseAuth" aria-labelledby="headingOne" data-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav">
                                            ...
                                            <a class="nav-link" href="empleados.php">Información Administrador</a>
